...
<div style="padding:10px;" id="content">
  	<div class="easyui-panel"  style="width:auto:">
	    ...
	    <form  method="post" style="margin-left:400px" action="email/addEquipment/save">
	    	<table>
	    		<tr>
	    			<td>邮件标题:</td>
	    		...
	    		<tr>
	    			...
	    			<td>
	    				...
	    				<a href="javascript:void(0)" rel="email/getEquipmentItem" openURL="db/toSearchItem/<%=MailItemType.equipment.getValue() %>/0" onclick="addMoneyItem(this)">添加</a>
	    				<div class="win"></div>
	    			</td>
	    		</tr>
	    		<tr>
	    ...
	    <div style="text-align:center;padding:5px">
	    	<a href="javascript:void(0)" reloadUrl="/email/addEquipment" class="easyui-linkbutton" onclick="moneySubmitForm(this)">提交</a>
	    </div>
	</div>
</div>
</body>
