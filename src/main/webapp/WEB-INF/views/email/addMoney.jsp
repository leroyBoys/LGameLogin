<%@page import="com.lgame.utils.enums.ItemType"%>
<%@page import="com.lgame.utils.enums.MailItemType"%>
...
<div style="padding:10px;" id="content">
  	<div class="easyui-panel content"  style="width:auto:">
	    	...
	    	<table>
	    		...
	    		<tr>
	    			...
	    			<td>
	    				...
	    				<a href="javascript:void(0)" rel="email/getMoneyItem" openURL="db/toSearchItem/<%=MailItemType.item.getValue() %>/money" onclick="addMoneyItem(this)">添加</a>
	    				<div class="win"></div>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>发送金锭数量:</td>
	    			<td><input type="text" class="easyui-numberbox"   name="email_cash"/></td>
	    		</tr>
	    		...
	    		<tr>
	    			<td>附件及金锭:</td>
	    			<td>
	    			<select multiple="multiple" class="attachs" size="1" ondblclick='removeSelect(this)'  name="email_attach">
    	...
    	<div style="text-align:center;padding:5px">
   	 		<a href="javascript:void(0)" class="easyui-linkbutton" reloadUrl="/email/addMoney" onclick="moneySubmitForm(this)">提交</a>
   		</div>
</div>
</div>
</body>
